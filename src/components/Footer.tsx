...
export function Footer() {
  ...
  const navigation = {
    support: [
      { name: 'Договор оферты', onclick: () => handleLinkClick('Рождество') },
  ...
  return (
    <footer 
        className="section px-3 flex justify-center bg-dark" 
        aria-labelledby="footer-heading"
    >
    <div
      className='container rounded-t-[20px] sm:p-10 p-5 py-10 sm:py-0'
    >
      ...
      <div className="mx-auto pb-8 pt-10 sm:pt-14 lg:pt-32">
        <div className="md:flex md:flex-row items-start justify-between md:gap-8">
          <div className="space-y-8 sm:w-1/3 w-[100%]">
            ...
            <p 
                className='sm:w-[80%] w-[70%] text-lead tracking-[1px] font-exo text-lg font-extralight leading-normal mt-6 mb-10'
            >
              SkladBox - Складские боксы в аренду в городе Лыткарино.
            </p>
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 font-light text-lead tracking-[0.4px]">&copy; 2023 SkladBox, Все права защищены.</p>
        </div>
      </div>
    </div>
    </footer>
